...
const fakeNames = [
  ...
  'Sinta Maharani', 'Andi Firmansyah', 'Dewi Kartika', 'Reza Mahendra', 'Fitri Handayani',
  'Budi Santoso', 'Mega Permata', 'Yoga Prasetyo', 'Rina Marlina', 'Agus Setiawan',
  ...
  'Mira Susanti', 'Fandi Ahmad', 'Lina Oktavia', 'Joko Suryanto', 'Ratna Sari',
  'Bagus Hernando', 'Yuni Astuti', 'Doni Prakarsa', 'Indah Permata', 'Wahyu Nugroho',
  'Citra Melani', 'Aldi Kurniawan', 'Maya Safira', 'Rangga Putra', 'Vina Rahayu',
  'Irfan Habibi', 'Anisa Rahma', 'Gilang Ramadhan', 'Dina Fitriani', 'Fikri Haikal',
  'Rosa Paramita', 'Naufal Abshar', 'Bella Anggraini', 'Kemal Farhan', 'Zahra Aurelia',
  'Tommy Kurniawan', 'Sella Nasution', 'Rio Darmawan', 'Cici Andriani', 'Bambang Hermawan',
  'Tiara Puspita', 'Rafif Nugroho', 'Shinta Pertiwi', 'Denny Saputra', 'Vanessa Oktaviani',
  'Kevin Pradipta', 'Lesti Purwanti', 'Gibran Maulana', 'Syifa Rahmani', 'Pratama Yudha',
  'Aurel Novitasari', 'Kresna Gamala', 'Fuji Ramadhani', 'Arkan Firdaus', 'Raisa Luthfia',
  'Jordi Satriya', 'Amanda Septiani', 'Iqbal Maulana', 'Maudy Rahmania', 'Alif Syahputra',
  'Prilly Wulandari', 'Stefan Nugraha', 'Natasha Kirana', 'Verrell Adiputra', 'Febby Larasati',
  'Bryan Aditya', 'Sandra Mellisa', 'Angga Yudhanto', 'Adhisty Safitri', 'Arbi Yasmin',
  'Reyhan Maulana', 'Dinda Kusumawardhani', 'Raska Fadhil', 'Ranty Maharani', 'Haris Firmansyah',
  'Lea Chairani', 'Bastian Putra', 'Mikha Anggraeni', 'Randy Maulana', 'Angela Gitasari',
  'Rizal Kurnia', 'Lestari Dewi', 'Jirawan Putra', 'Rachel Oktaviani', 'Fadil Ramadhan',
  'Bintang Erlangga', 'Sisca Maharani', 'Jerome Saputra', 'Tasya Febriana', 'Windah Kurniawati',
  'Jesslyn Tanuwijaya', 'Mirza Aditya', 'Onic Satriya', 'Bayu Laksana', 'Raka Hastomo',
  'Evan Saputra', 'Altero Pratama', 'Bintang Ramadhan', 'Geofani Dwi', 'Nabil Valerian',
  'DedekGaming', 'FrostPlayer_ID', 'BangAlex_ID', 'KenZero_GG', 'SkinnyGamerID',
  'AkuGamer_ID', 'PakBoss_GG', 'MboiGaming', 'GamerCewek01', 'NoobSlayer69',
  'ProPlayerKW', 'SultanSteam', 'AnakMama_GG', 'ChickenDinner99', 'GabutGaming',
  'SteamLoverID', 'GameManiac', 'IndoGamer', 'KocakGaming', 'SantaiAja',
  'NoLifeGamer', 'WibuGaming', 'OtakuSteam', 'MagerPlayer', 'CoolGamerID',
  'TuyulGamer', 'BocilSangar', 'KangGame', 'PejuangWeekend', 'SteamAddictID',
  'GasPolGame', 'CuanGaming', 'MantapJiwa', 'BarBarKing', 'AFK_Player',
  'MabarYuk', 'PushRankID', 'LegendGamer', 'AntiMetaID', 'SoloCarryGG',
  'TopFragger', 'GGWellPlayed', 'EZGameEZLife', 'GitGudBro', 'SteamSaleHunter',
];
